...
export interface ICryptoExchangePrivateKey extends ISerializableAsync {
...
export class CryptoExchangePrivateKey extends CryptoPrivateKey implements ICryptoExchangePrivateKey, IClearable {
    ...
    public static from(value: CryptoExchangePrivateKey | ICryptoExchangePrivateKey): Promise<CryptoExchangePrivateKey> {
        return Promise.resolve(new CryptoExchangePrivateKey(value.algorithm, CoreBuffer.from(value.privateKey)));
    }

    public static fromJSON(value: ICryptoExchangePrivateKeySerialized): Promise<CryptoExchangePrivateKey> {
        ...
        return Promise.resolve(new CryptoExchangePrivateKey(value.alg as CryptoExchangeAlgorithm, buffer));
    }

    public static fromBase64(value: string): Promise<CryptoExchangePrivateKey> {
        return this.deserialize(CoreBuffer.base64_utf8(value));
    }

    public static async deserialize(value: string): Promise<CryptoExchangePrivateKey> {
